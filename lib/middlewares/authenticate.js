...
module.exports = function authenticate(req, res, callback) {
  ...
  switch (req.body.identityType) {
    case 'pubkeyhash':
      return _fetchLocalIdentity(req.body.identity, verify);
    case 'href':
      return _fetchRemoteIdentity(req.body.identity, verify);
    default:
      return callback();
  }
  ...
  function verify(err, pubkey) {
    ...
    if (req.authenticated) {
      var hash = new sha3.SHA3Hash(512);
